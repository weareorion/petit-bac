...
class _GameScreenState extends ConsumerState<GameScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref
          .read(gameSessionProvider(widget.selectedLetter).notifier)
          .startTimer(onTimeUp: _finishGame);
    });
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      HeaderIndicator(
                        label: "TEMPS",
                        value: _formatTime(sessionNotifier.secondsRemaining),
                        backgroundColor:
                ...
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: isLoading ? null : _finishGame,
